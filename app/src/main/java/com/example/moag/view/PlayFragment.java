...
import com.example.moag.models.Achievements;
import com.example.moag.viewmodel.GameViewModel;
...
public class PlayFragment extends Fragment {
    ...
    public class PlayAdapter extends RecyclerView.Adapter<PlayHolder> {
        ...
        private boolean checkForPair() {
            ...
            if (mSelectedTilesPositions.get(0).second == mSelectedTilesPositions.get(1).second) {
        ...
        private void updateScore(int turns, int sequence, int time) {
            ...
            //Inform the gameview model about the new score
